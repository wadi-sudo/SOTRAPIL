        ...
        <se:Rule>
          ...
          <se:PointSymbolizer>
            <se:Graphic>
              <!--Parametric SVG-->
              <se:ExternalGraphic>
                <se:OnlineResource xlink:type="simple" xlink:href="C:/geodjango/geodjango-app/food_cafe.svg?fill=%23169306&amp;fill-opacity=1&amp;outline=%23232323&amp;outline-opacity=1&amp;outline-width=1"/>
                <se:Format>image/svg+xml</se:Format>
              </se:ExternalGraphic>
              <!--Plain SVG fallback, no parameters-->
              <se:ExternalGraphic>
                <se:OnlineResource xlink:type="simple" xlink:href="C:/geodjango/geodjango-app/food_cafe.svg"/>
                <se:Format>image/svg+xml</se:Format>
              </se:ExternalGraphic>
              ...
              <se:Mark>
                ...
                <se:Fill>
                  <se:SvgParameter name="fill">#169306</se:SvgParameter>
                </se:Fill>
                <se:Stroke>
